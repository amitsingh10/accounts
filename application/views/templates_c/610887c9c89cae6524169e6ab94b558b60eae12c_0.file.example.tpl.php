<?php
/* Smarty version 3.1.30, created on 2017-06-27 13:49:17
  from "/data/web/virtuals/115873/virtual/www/application/views/templates/example.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5952463d2841a9_54944422',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '610887c9c89cae6524169e6ab94b558b60eae12c' => 
    array (
      0 => '/data/web/virtuals/115873/virtual/www/application/views/templates/example.tpl',
      1 => 1498303919,
      2 => 'file',
    ),
  ),
...
function content_5952463d2841a9_54944422 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_capitalize')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_function_ci_config')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/function.ci_config.php';
if (!is_callable('smarty_modifier_date_format')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_ci_language')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/function.ci_language.php';
if (!is_callable('smarty_function_ci_form_validation')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/function.ci_form_validation.php';
if (!is_callable('smarty_function_html_options')) require_once '/data/web/virtuals/115873/virtual/www/application/third_party/smarty/libs/plugins/function.html_options.php';
